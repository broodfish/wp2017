...
$(document).ready(function(){
  $(document).click(function(){
    if(x==1){
      ...
      $("#pic").animate({marginTop:"70%"},"slow").transition('fade up');
      ...
      $("#profile").animate({marginTop:"70%"},"slow").transition('fade up');
      ...
      $("#contact").animate({marginTop:"70%"},"slow").transition('fade up');
